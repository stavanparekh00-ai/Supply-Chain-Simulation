...
> = {
  F3: {
    ...
    regional_partner: [231, 332, 419, 700, 382, 411, 494, 582, 624, 84],
    overseas_manufacturer: [800, 800, 800, 0, 0, 616, 800, 800, 800, 126],
  },
  F4: {
    domestic_fab: [900, 92, 369, 615, 561, 379, 39, 0, 87, 0],
    regional_partner: [396, 418, 471, 700, 700, 559, 586, 388, 574, 152],
    overseas_manufacturer: [800, 763, 800, 0, 0, 800, 800, 580, 800, 228],
  },
};
